...
var AboutComponent = /** @class */ (function () {
    function AboutComponent(subscribeservice) {
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(subscribeservice, router, route) {
        this.subscribeservice = subscribeservice;
        this.router = router;
        this.route = route;
        this.inboolean = true;
    ...
    HeaderComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.subscribeservice.header.subscribe(function (title) {
            _this.header = title;
        });
        this.subscribeservice.token.subscribe(function (tok) {
            _this.tokennumber = tok;
        });
        this.subscribeservice.userData.subscribe(function (user) {
            // console.log(user);
            if (user != null) {
                _this.inboolean = false;
                _this.tokenflag = true;
            }
        });
    };
    ...
    HeaderComponent.prototype.navigateLogin = function () {
        this.router.navigate(['../login'], { relativeTo: this.route }).catch();
    };
    HeaderComponent.prototype.navigateUpload = function () {
    ...
    HeaderComponent.prototype.navigateAbout = function () {
        this.router.navigate(['../about'], { relativeTo: this.route }).catch();
    };
    HeaderComponent.prototype.navigateHeatmap = function () {
        this.router.navigate(['../heatmap'], { relativeTo: this.route }).catch();
    };
    HeaderComponent.prototype.nagigateSymptoms = function () {
...
var HeatmapComponent = /** @class */ (function () {
    function HeatmapComponent(subscribeservice, appservice) {
        var _this = this;
        this.subscribeservice = subscribeservice;
        ...
        this.appservice.gatherHeatMapDataApi()
            ...
            if (response.status == 200) {
                response.body.forEach(function (data) {
                    ...
                    _this.heatMapData.push(tempData);
                    _this.appservice.getPosition()
                        .then(function (pos) {
                        _this.latitude = "" + pos.lat;
                        _this.longitude = "" + pos.lng;
                        _this.userlocation = new google.maps.LatLng(Number(_this.latitude), Number(_this.longitude));
                        _this.ngInitManual();
                    }).catch(function (err) {
                        _this.userlocation = new google.maps.LatLng(22.5726, 88.3639);
                        _this.ngInitManual();
                        console.log(err);
                    });
                });
    ...
    HeatmapComponent.prototype.ngInitManual = function () {
        this.subscribeservice.setHeader('Heat Map of Infected Regions Across India');
        this.mapInitializer();
    };
    HeatmapComponent.prototype.mapInitializer = function () {
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(appservice, subscribeservice, router, route) {
        this.appservice = appservice;
        this.subscribeservice = subscribeservice;
        this.router = router;
        this.route = route;
        ...
        if (this.phoneNumber != "" && this.password != "") {
            if (this.phoneNumber.length != 10) {
                ...
                this.appservice
                    ...
                    _this.userloader = false;
                    if (response.status == 200) {
                        _this.subscribeservice.setUserData(response.body['Name']);
                        _this.subscribeservice.setToken(response.body['Token']);
                        _this.router.navigate(['../heatmap'], { relativeTo: _this.route }).catch();
                    }
                    else if (response.status == 204) {
                        _this.errorFlag = true;
                        _this.errorMsg = "Authentication Failed";
                    }
                }).catch(function (err) {
                    _this.userloader = false;
                    console.log(err);
...
var MainpageComponent = /** @class */ (function () {
    function MainpageComponent(appservice, subscribeservice, router, route) {
        this.appservice = appservice;
        this.subscribeservice = subscribeservice;
        this.router = router;
        this.route = route;
    ...
    MainpageComponent.prototype.ngOnInit = function () {
        ...
        this.appservice
            ...
            if (response.status != 200) {
                ...
                console.log(response);
                response.body.forEach(function (stateData) {
                    var statemodel = new _models_models__WEBPACK_IMPORTED_MODULE_5__["StateData"](stateData);
                    var stateMapModel = new _models_models__WEBPACK_IMPORTED_MODULE_5__["StateMapData"](stateData);
                    _this.stateFullData.push(statemodel);
                    _this.stateMapFullData.push(stateMapModel);
                });
                console.log(_this.stateFullData);
                console.log(_this.stateMapFullData);
                _this.dataSource = {
                    "chart": {
                    ...
                    "data": _this.stateMapFullData
                };
                _this.fetchGroupDataDone = true;
            }
        }).catch(function (err) {
            _this.fetchGroupDataDone = true;
            console.log(err);
    ...
    MainpageComponent.prototype.gotoState = function (event) {
    ...
    MainpageComponent.prototype.initializedMap = function (event) {
...
var StateData = /** @class */ (function () {
    ...
    StateData.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return StateData;
}());

var StateMapData = /** @class */ (function () {
    function StateMapData(data) {
        this.id = data['id'];
        this.value = data['infected'];
        this.showLabel = "1";
    }
    StateMapData.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return StateMapData;
}());
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(appservice, subscribeservice, router, route) {
        this.appservice = appservice;
        this.subscribeservice = subscribeservice;
        this.router = router;
        this.route = route;
    ...
    RegisterComponent.prototype.registerUser = function () {
        ...
        if (this.phonenumber != "" && this.email != "" && this.password != "" && this.confirmPassword != "") {
            ...
            if (this.phonenumber.length != 10) {
                ...
                this.userloader = true;
                this.appservice
                    .registerApi(payload).then(function (response) {
                    _this.userloader = false;
                    if (response.status == 201) {
                        _this.router.navigate(['../login'], { relativeTo: _this.route }).catch();
                    }
                }).catch(function (err) {
                    console.log(err);
                });
    ...
    RegisterComponent.prototype.requestOtp = function () {
        var _this = this;
        if (this.email != "") {
            if (/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/.test(this.email)) {
                ...
                this.userloader = true;
                this.appservice
                    .messageOtpApi(payload).then(function (response) {
                    _this.userloader = false;
                    if (response.status == 200) {
                        _this.errorflag = false;
                        _this.otpFromApi = response.body['OTP'];
                        _this.otpValidate = true;
                    }
                }).catch(function (err) {
                    _this.userloader = false;
                    if (err['status'] == 409) {
                        _this.errorMsg = err['error']['OTP'];
                        _this.errorflag = true;
                        _this.email = "";
                    }
                    console.log(err);
    ...
    RegisterComponent.prototype.clearfields = function () {
        this.phonenumber = "";
        this.password = "";
        this.confirmPassword = "";
        this.email = "";
...
var AppService = /** @class */ (function () {
    ...
    AppService.prototype.registerApi = function (credentials) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var url;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                url = this.BASE_URL + "/register";
                return [2 /*return*/, this.http.post(url, credentials, this.httpOptions).toPromise()];
            });
        });
    };
    AppService.prototype.messageOtpApi = function (credentials) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var url;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                url = this.BASE_URL + "/send_otp";
                return [2 /*return*/, this.http.post(url, credentials, this.httpOptions).toPromise()];
            });
        });
    };
    AppService.prototype.loginApi = function (credentials) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var url;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    AppService.prototype.uploadApi = function (credentials) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var url;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                url = this.BASE_URL + "/crowd_detection";
                return [2 /*return*/, this.http.post(url, credentials, this.httpOptions).toPromise()];
            });
        });
    };
    AppService.prototype.uploadVideoApi = function (credentials) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var url;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                url = this.BASE_URL + "/crowd_detection_video";
                return [2 /*return*/, this.http.post(url, credentials, this.httpOptions).toPromise()];
            });
        });
    };
    AppService.prototype.getPosition = function () {
    ...
    AppService.prototype.gatherDataApi = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var url;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                url = this.BASE_URL + "/state_data";
                return [2 /*return*/, this.http.get(url, this.httpOptions).toPromise()];
            });
        });
    };
    AppService.prototype.gatherHeatMapDataApi = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var url;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                url = this.BASE_URL + "/get_heatmap";
                return [2 /*return*/, this.http.get(url, this.httpOptions).toPromise()];
            });
        });
    };
...
var SubscribeService = /** @class */ (function () {
    ...
    SubscribeService.prototype.setUserData = function (role) {
        this.userData.next(role);
    };
    SubscribeService.prototype.setId = function (id) {
        this.id.next(id);
    };
    SubscribeService.prototype.setHeader = function (header) {
        this.header.next(header);
    };
    SubscribeService.prototype.setToken = function (tok) {
        this.token.next(tok);
    };
...
var SymptomsComponent = /** @class */ (function () {
    function SymptomsComponent(subscribeservice) {
        this.subscribeservice = subscribeservice;
    }
...
var TestingComponent = /** @class */ (function () {
    ...
    TestingComponent.prototype.ngOnInit = function () {
        this.appservice.getPosition().then(function (pos) {
...
var UploadComponent = /** @class */ (function () {
    function UploadComponent(appservice, subscribeservice, router, route) {
        this.appservice = appservice;
        this.subscribeservice = subscribeservice;
        this.router = router;
        this.route = route;
    ...
    UploadComponent.prototype.ngOnInit = function () {
        ...
        this.subscribeservice.userData.subscribe(function (user) {
            ...
            if (user == null) {
                ...
                _this.subscribeservice.token.subscribe(function (tok) {
                    // tok=5;
                    _this.tokenFlag = (tok > 0) ? true : false;
                });
                _this.subscribeservice.setHeader('Upload Images on Crowd Gathering');
                _this.appservice.getPosition()
                    .then(function (pos) {
                    console.log("Position: " + pos.lng + " " + pos.lat);
                    _this.latitude = "" + pos.lat;
    ...
    UploadComponent.prototype.addPictures = function () {
        var _this = this;
        this.userloader = true;
        if (this.videoFlag == false) {
            ...
            this.appservice
                .uploadApi(this.finalJson).then(function (response) {
                console.log(response);
                _this.userloader = false;
                if (response.status == 200) {
                    _this.successFlag = true;
                    _this.userloader = false;
                    _this.successMsg = response.body['Person Count'];
            ...
            this.appservice
                .uploadVideoApi(this.finalJson).then(function (response) {
                console.log(response);
                _this.userloader = false;
                if (response.status == 200) {
                    _this.userloader = false;
    ...
    UploadComponent.prototype.picked = function (event, field) {
        console.log(event);
    ...
    UploadComponent.prototype.handleInputChange = function (files) {
        var _this = this;
        var file = files;
        this.submitEnable = true;
        var pattern1 = /image-*/;
    ...
    UploadComponent.prototype._handleReaderLoaded = function (e) {
        var reader = e.target;
    ...
    UploadComponent.prototype.log = function () {
        // for debug
